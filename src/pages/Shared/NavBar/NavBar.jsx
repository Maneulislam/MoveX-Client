...
const NavBar = () => {
    ...
    const links = [
        ...
        role === 'user' && (
            <li key="tracking"><NavLink to="/dashboard/parcel-tracking" className={navLinkStyle}>Track Order</NavLink></li>
        ),

        <li key="about-us"><NavLink to="/about-us" className={navLinkStyle}>About Us</NavLink></li>,
        <li key="contact"><NavLink to="/contact" className={navLinkStyle}>Contact</NavLink></li>,
    ].filter(Boolean);
